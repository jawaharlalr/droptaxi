...
export default function Contact() {
  ...
  return (
    <div className="relative min-h-screen bg-gradient-to-br from-black via-[#0d0d0d] to-[#1a1a1a] text-white px-4 py-12 flex flex-col items-center">
      {/* Home Button */}
      <Link
        to="/"
      ...
      <div className="flex flex-col items-center w-full max-w-5xl text-center">
        <h1 className="mb-1 text-sm font-semibold text-yellow-400 uppercase">
          Contact Us
        </h1>
        <h2 className="mb-10 text-4xl font-bold">Pranav Drop Taxi</h2>
      </div>

      {/* Grid Layout */}
      <div className="grid items-start w-full max-w-5xl gap-12 md:grid-cols-2">
        {/* Contact Info */}
        ...
        <div className="flex flex-col items-center w-full gap-4">
          <div className="w-full overflow-hidden shadow-lg rounded-2xl">
            <iframe
