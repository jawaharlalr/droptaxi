...
const LocationInputs = ({
  ...
  return (
    <div className="space-y-4">
      {/* Pickup */}
      <div>
        <label className="block mb-1 text-sm text-gray-300">Pickup Location</label>
        <div
          id="pickup-input"
      ...
      {/* Drop */}
      <div>
        <label className="block mb-1 text-sm text-gray-300">Drop Location</label>
        <div
          id="drop-input"
          className={`p-2 text-black bg-white border rounded ${
            dropError ? 'border-red-500' : 'border-gray-300'
          }`}
        />
        {dropError && (
